...
products = [
    ...
    },
    {
      ...
      "description":
        "Samsung Galaxy A07 6 ГБ/128 ГБ — это универсальный смартфон для тех, ценит производительность и большой объем памяти для хранения ваших данных.",
      "rating": 5,
      "price": 73990,
    ...
    },
    {
      ...
      "description": "Представляем Apple MacBook Air 13 2025",
      "rating": 5,
      "price": 531494,
    ...
    },
    {
      ...
      "description": "New 2024 14 inch MacBook Pro",
      "rating": 5,
      "price": 1131902,
    ...
    },
    {
      ...
      "description": "New 2024 14-inch MacBook Pro - Silver",
      "rating": 5,
      "price": 1163688,
      "image": "https://resources.cdn-kaspi.kz/img/m/p/h06/h08/64213171568670.jpg?format=preview-large",
      "images": [
    ...
    },
    {
      ...
      "description": "Представляем iPad A16 2025...",
      "rating": 5,
      "price": 207361,
    ...
    },
    {
      ...
      "description": "Новый планшет Apple iPad Air 11 (2025)...",
      "rating": 5,
      "price": 330606,
    ...
    },
    {
      ...
      "description": "Apple iPad Air 11 2025 мощный...",
      "rating": 5,
      "price": 409541,
    ...
    },
    {
      ...
      "description": "Новый эргономичный дизайн наушников...",
      "rating": 0,
      "price": 139880,
    ...
    },
    {
      ...
      "description": "Модель автоматически умеет определять...",
      "rating": 5,
      "price": 279480,
    ...
    },
    {
      ...
      "description": "Наушники Sony WH-1000XM6...",
      "rating": 5,
      "price": 190411,
...
for p_data in products:
    category = Category.objects.get(id=p_data["categoryId"])
    Product.objects.create(
        id=p_data["id"],
        name=p_data["name"],
        description=p_data["description"][:255] if len(p_data["description"]) > 255 else p_data["description"], # Just to be safe with lengths, though textfield handles any length.
